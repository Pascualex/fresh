...
/**
 * Esta vista define la pestaña de nuevas canciones del administrador
 */
public class VistaNuevasCanciones extends JPanel {
    ...
    public VistaNuevasCanciones() {
        ...
        textoSinResultados = new JLabel("No hay canciones por validar");
