 ...
 */
public class CSModuloMP3 implements Runnable {
     ...
     */
    public CSModuloMP3(Configuracion configuracion) {
    ...
    public synchronized void siguiente() {
        if (sig != null) {
            ...
            sig = new CSModuloMP3(configuracion);
            if (modoEjecucion == ModoEjecucion.REGISTRADO) {
